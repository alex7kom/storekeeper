  ...
  function (callback) {
    ...
    sk.steam.on('error', function (e) {
      if (e.cause == 'loggedOff') {
        sk.steam.logOn(loginOptions);
      } else if (e.result == 'InvalidPassword') {
